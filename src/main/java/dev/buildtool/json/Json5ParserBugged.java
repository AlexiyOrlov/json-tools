 ...
 */
@Deprecated
public class Json5ParserBugged {
     ...
     */
    public Json5ParserBugged(String source) {
        this.source = source;
    }
...
//
    ...
    /**
     * Reads next char and advances the position;
    ...
    class LexStates {
        Token match(String lexState) throws Json5SyntaxError {
            switch (lexState) {
                ...
                case "sign":
                    return sign();
                case "decimalPointLeading":
                    return decimalPointLeading();
                case "zero":
                    return zero();
                case "decimalInteger":
                ...
                case "identifierNameEscape":
                    return identifierNameEscape();
                case "decimalPoint":
                    return decimalPoint();
                ...
                case "end":
                    return end();
                case "identifierNameStartEscape":
                    return identifierNameStartEscape();
                default:
                    return null;
            }
        }
...
//                case '\v':
        ...
        Token multiLineCommentAsterisk() {
            switch (c) {
                case '*':
                    read();
                    return null;
        ...
        Token value() throws Json5SyntaxError {
            switch (c) {
                ...
                case '{':
                case '[':
                    return newToken("punctuator", String.valueOf(read()));
                case 'n':
                    read();
                    literal("ull");
                ...
                case 'I':
                    read();
                    literal("nfinity");
                    return newToken("numeric", Double.POSITIVE_INFINITY);
                case 'N':
                    read();
                    literal("aN");
        ...
        Token sign() throws Json5SyntaxError {
            switch (c) {
                ...
                case 'I':
                    read();
                    literal("nfinity");
                    return newToken("numeric", sign * Double.POSITIVE_INFINITY);
                case 'N':
                    read();
                    literal("aN");
                    return newToken("numeric", Double.NaN);
